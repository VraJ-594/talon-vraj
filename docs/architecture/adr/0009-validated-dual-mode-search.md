...
only the user text and a versioned restricted DSL schema to Grok behind an application-owned port.
...
4,000,000 or 400,000,000 paise. No cross-currency conversion is inferred. Grok failure returns a
clear interpretation error while explicit filters and Cmd+K remain operational.

## Consequences

- Search remains useful without xAI availability or billing.
